    ...
    <section className="section-padding bg-gradient-to-b from-card-bg to-cream">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="font-heading text-4xl md:text-5xl text-dark mb-4">Devotees Speak</h2>
          <p className="text-muted max-w-xl mx-auto">Real stories from real devotees who found divine connection through ePoojapaath.</p>
        </div>
          ...
          {testimonials.map(({ name, city, avatar, rating, text, puja }, i) => (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <div className="font-heading text-dark text-lg">{name}</div>
              ...
              <p className="text-muted text-sm leading-relaxed mb-3">&ldquo;{text}&rdquo;</p>
